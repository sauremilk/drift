...
- `adr_scanner`: stdlib-only parser for `docs/decisions/*.md`; returns active ADRs (accepted/proposed) filtered by scope paths and task keywords.
...
- `copilot-instructions.md`: mandatory Post-Edit Drift-Nudge section; `drift.yaml`: `doc_impl_drift` excluded from `docs/decisions/*`.
