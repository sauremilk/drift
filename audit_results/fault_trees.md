...
AVS reports header-marked generated files without `.generated.*` naming as actionable architecture violations.

### FT-1: false-positive branch

```
          TE-FP: header-marked generated file reported as actionable AVS architecture violation
                         |
                      OR-Gate
               +---------+---------+
              IE-1      IE-2
...
- **IE-1 (MCS)**: AVS suppression relied on generated filename/path conventions and missed generated files with regular names.
  - Mitigation: add bounded header-marker detection in AVS input filtering (`auto-generated`, `autogenerated`, `generated by ... do not edit`).
- **IE-2 (MCS)**: Codegen output naming conventions vary across repositories, so filename-only filtering misses equivalent generated artifacts.
  - Mitigation: scan first header lines for explicit generator markers before building AVS graph.

### FT-2: false-negative guard

- **IE-3 (Guard)**: header-based suppression could hide true issues in hand-written files that copy generated banners.
  - Mitigation: keep marker set strict and bounded to explicit generator phrases in top-of-file header lines only.
...
TVS reports auto-generated files as actionable temporal volatility hotspots.

### FT-1: false-positive branch

```
          TE-FP: generated file reported as actionable temporal instability
                         |
                      OR-Gate
               +---------+---------+
              IE-1      IE-2
...
- **IE-1 (MCS)**: TVS volatility scoring lacked generated-file context and treated `*.generated.ts/js` churn as production instability.
  - Mitigation: classify `.generated.{ts,tsx,js,jsx}` paths as generated context.
- **IE-2 (MCS)**: TVS had no content-level guard for explicit codegen headers (`Auto-generated`, `generated by`, `Do not edit directly`).
  - Mitigation: add bounded header-marker check in first lines and skip finding emission when present.

### FT-2: false-negative guard

- **IE-3 (Guard)**: broad generated suppression can hide real instability in hand-written files with misleading markers.
  - Mitigation: keep suppression tightly bounded to explicit `.generated.` filename convention and explicit auto-generated header markers only.
