...
def test_is_test_file_patterns() -> None:
    ...
    assert is_test_file(Path("src/test-utils/channel-plugins.ts"))
    assert is_test_file(Path("src/test-utils/repo-scan.ts"))
    assert is_test_file(Path("packages/test-utils/helper.ts"))
